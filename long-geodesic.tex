...
it will look like a surface if you can walk on both sides of the figure but can not pass directly to the other side.
...
The functional $\kappa$ uniquely extends to non-negative measure, the so called the \index{curvature measure}\emph{curvature measure}, defined on all Borel subsets in the interior of $\Sigma$.
...
\begin{thm}{Lemma} 
Assume that a closed convex surface in $\RR^3$
