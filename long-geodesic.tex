...
If $\Sigma$ has nonnegative curvature in the sense of Alexandrov, then applying the supplementary property we get that $\phi_-+\phi_+=\pi$, hence $\cos\phi_+ +\cos\phi_-=0$.
...
We also will use the following area comparison,
it follows easily from the comparison property.
