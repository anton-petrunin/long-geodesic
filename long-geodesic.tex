...
A short introduction to the subject was written by Alexander Alexandrov in \cite{alexandrov1941}. 
Later he wrote a comprehensive book on the subject \cite{alexandrov1948} which we recommend to anyone who can read Russian or German,
otherwise read the book of Herbert Busemann \cite{busemann}.
...
That is any distance nonexpanding map from a subset of surface to the Euclidean plane can be exteded to a distance nonexpanding map defined on whole $\Sigma$;
see \cite{LS,AKP}.

From Kiszbraun theorem, one can ealiy get the following area comparison which will be important to us.
...
In fact, as it was prove by Alexandrov in \cite{alexandrov1948},
...
it was proved by Pogorelov, see \cite{pogorelov}.
We will use the following weaker statement proved by Alexandrov in \cite{alexandrov1950}.
...
Alexandroff, A. 
\emph{The inner geometry of an arbitrary convex surface.}
