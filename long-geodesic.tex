...
Especially, geodesics in $\Sigma$ can not bifurcate.
...
Specifically, $f$ is differentiable almost everywhere.
...
at any $t$ such that the derivative $f'(t)$ is defined (see  \cite[Chapter XI \S 2, Equation (7)]{ aleksandrov1948vnutrennnyaya, alexandrow1955dieinnere}). 
...
\begin{thm}{Theorem}\cite[Chapter VI-VII]{aleksandrov1948vnutrennnyaya, alexandrow1955dieinnere}
...
This hard theorem was proved by Pogorelov \cite{pogorelov1952odnoznacnaya}.
We will use the following weaker statement, which goes essentially the same way as the Cauchy's rigidity theorem.

\begin{thm}{Rigidity theorem}\cite[Chapter VI \S 5]{aleksandrov1948vnutrennnyaya, alexandrow1955dieinnere}
	\label{Rigidity theorem}
